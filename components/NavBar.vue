    ...
    <div class="flex items-center justify-between bg-indigo-600 px-1 py-2">
      ...
      <div class="hidden md:block">
        <ul style="list-style: none" class="flex space-x-8">
          ...
          <li><a href="/urban" class="text-white">都市規劃</a></li>
          <li><a href="/transportation" class="text-white">交通指南</a></li>
          <li><a href="/houses" class="text-white">建案匯總</a></li>
          <li><a href="/market" class="text-white">房市行情</a></li>
          <li>
            <a
              href="/websites"
      ...
      >
        ...
        <ul style="list-style: none" class="divide-y text-base">
          ...
          <li>
            <a href="/urban" @click="isOpen = false" class="my-2 inline-block"
              >都市規劃</a
            >
          </li>
          <li>
          ...
          <li>
            <a href="/houses" @click="isOpen = false" class="my-2 inline-block"
              >建案匯總</a
            >
          </li>
          <li>
            <a href="/market" @click="isOpen = false" class="my-2 inline-block"
              >房市行情</a
            >
          </li>
          <li>
